...
Vue.component('mission', {
	data: function () {
		...
		platoons: [
				...
				["Bastila Shan (Dark)", "Savage Opress", "Nightsister Zombie", "Old Daka", "Darth Nihilus", "Royal Guard", ],
				["Director Krennic", "General Veers", "Nightsister Initiate", "Savage Opress", "Darth Maul", "Bastila Shan (Dark)", ],
				["TIE Fighter Pilot", "Sith Trooper", "Talia", "Nightsister Initiate", "Sith Trooper", "Grand Moff Tarkin", ],
				["Darth Nihilus", "HK-47", "Darth Traya", "Wampa", "Bastila Shan (Dark)", "Captain Phasma", ],
				["Sith Assassin", "Jango Fett", "Jango Fett", "Director Krennic", "Imperial Super Commando", "First Order Stormtrooper", ],
				["Sith Trooper", "IG-86", "Bastila Shan (Dark)", "IG-86", "Mother Talzin", "First Order TIE Pilot", ],
				["Bastila Shan (Dark)", "Darth Traya", "Bossk", "Bossk", "Director Krennic", "First Order Officer", ],
				...
				["Tusken Shaman", "Bastila Shan (Dark)", "First Order Stormtrooper", "TIE Fighter Pilot", "Darth Revan", "Darth Maul", ],
				...
				["Grand Moff Tarkin", "Range Trooper", "Mother Talzin", "Bastila Shan (Dark)", "Gar Saxon", "Sith Trooper", ],
/*30 */
...
/*45 */
				["General Grievous", "Cad Bane", "Darth Sion", "Cad Bane", "Bastila Shan (Dark)", "Bastila Shan (Dark)", ],
				...
				["General Grievous", "Stormtrooper", "Nute Gunray", "First Order Stormtrooper", "Bastila Shan (Dark)", "First Order SF TIE Pilot", ],
				["Magmatrooper", "Imperial Probe Droid", "Darth Traya", "First Order TIE Pilot", "Boba Fett", "First Order TIE Pilot", ],
				["Imperial Probe Droid", "Droideka", "General Grievous", "Bastila Shan (Dark)", "Greedo", "Darth Traya", ],
...
/*60*/
				["General Grievous", "Imperial Super Commando", "First Order Officer", "General Grievous", "Bastila Shan (Dark)", "Darth Revan", ],
				["Death Trooper", "Darth Revan", "General Grievous", "Bastila Shan (Dark)", "Canderous Ordo", "Gar Saxon", ],
				...
				["Darth Traya", "Bastila Shan (Dark)", "Kylo Ren Unmasked", "Kylo Ren Unmasked", "First Order TIE Pilot", "Tusken Raider", ],
				...
				["Bastila Shan (Dark)", "Nightsister Initiate", "Jango Fett", "Cad Bane", "Darth Traya", "General Grievous", ],
				...
				["Mother Talzin", "General Grievous", "Bastila Shan (Dark)", "Darth Revan", "Stormtrooper", "Bastila Shan (Dark)", ],
...
/*90*/
				["Captain Phasma", "Asajj Ventress", "Bossk", "Bastila Shan (Dark)", "Darth Traya", "Bastila Shan (Dark)", ],
...
/*135*/
				["Captain Phasma", "Emperor Palpatine", "Jango Fett", "Darth Sion", "Mother Talzin", "Bastila Shan (Dark)", ],
...
/*150*/
				...
				["Darth Revan", "Mother Talzin", "Director Krennic", "Bossk", "Darth Malak", "Bastila Shan (Dark)", ],
